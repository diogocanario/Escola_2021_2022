package amsi.dei.estg.ipleiria.guess;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onclickGuess(View view) {
        ...
        Toast.makeText(this, "valor escolhido: "+number, Toast.LENGTH_LONG).show();
    ...
    private void showToast(String s) {
        ...
        Toast toast = Toast.makeText(this, "numero gerado",duration);
        toast.show();
    }
